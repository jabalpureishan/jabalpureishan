#python3.13 -m pip install langchain langchain-community faiss-cpu huggingface_hub sentence-transformers
...
# Example: "mistralai/Mistral-7B-Instruct" or "HuggingFaceH4/zephyr-7b-beta"
llm = HuggingFaceEndpoint(
    repo_id="mistralai/Mistral-7B-Instruct",
    huggingfacehub_api_token="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",   # <<< Replace with your Hugging Face token
    temperature=0.2,
    max_new_tokens=256,
)
